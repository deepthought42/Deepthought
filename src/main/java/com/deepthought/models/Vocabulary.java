 ...
 * between words/tokens and their indices for use in token vectors and weight matrices.
 *
 * This class provides:
...
public class Vocabulary {
    ...
    /**
     * Creates a new vocabulary with the given label and initial tokens
     *
     * @param tokens Initial list of tokens to add to the vocabulary
     * @param label The name/label for this vocabulary
     */
    public Vocabulary(List<Token> tokens, String label) {
        this(label);
        if (tokens != null) {
            for (Token token : tokens) {
                this.appendToVocabulary(token);
            }
        }
    }
    ...
    /**
     * Adds a Token to the vocabulary by its value
     *
     * @param token The token to add
     * @return The index of the token's value
     */
    public int appendToVocabulary(Token token) {
        if (token == null || token.getValue() == null) {
            throw new IllegalArgumentException("Token and its value cannot be null");
        }
        return addWord(token.getValue());
    }
    ...
    /**
     * Gets the list of tokens corresponding to the vocabulary words
     *
    ...
    /**
     * Creates a token vector representation of the vocabulary
     ...
     */
    public boolean[] createTokenVector(List<String> inputWords) {
