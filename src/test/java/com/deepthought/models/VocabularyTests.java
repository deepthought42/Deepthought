...
public class VocabularyTests {
    ...
    @Test
    public void testConstructorWithTokens() {
        ...
        Vocabulary vocab = new Vocabulary(tokens, "test_tokens");
        assertEquals("test_tokens", vocab.getLabel());
    ...
    public void testAppendToVocabulary() {
        Token token1 = new Token("test_word");
        Token token2 = new Token("another_word");

        int index1 = vocabulary.appendToVocabulary(token1);
        int index2 = vocabulary.appendToVocabulary(token2);
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testAppendToVocabularyNullTokenThrowsException() {
    ...
    public void testGetTokens() {
        ...
        List<Token> tokens = vocabulary.getTokens();
        assertEquals(2, tokens.size());
        assertEquals("hello", tokens.get(0).getValue());
        assertEquals("world", tokens.get(1).getValue());
    }

    @Test
    public void testCreateTokenVector() {
        vocabulary.addWord("hello");
        vocabulary.addWord("world");
        ...
        boolean[] vector = vocabulary.createTokenVector(inputWords);
